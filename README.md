# DK64 but you grow in size the more bananas you have

The more bananas you have for a level, the bigger the kong

## Installation
1. Download the latest `mini-dk64.nrm` from Releases.
...
The produced mod file is named `mini-dk64.nrm`.
